...
const AdminProducts = () => {
  ...
  const mockProducts = [
    ...
    { id: 3, name: 'Programming Book', category: 'Books', price: 49.99, stock: 30, image: 'https://via.placeholder.com/50' },
    { id: 4, name: 'Coffee Maker', category: 'Home & Garden', price: 79.99, stock: 15, image: 'https://via.placeholder.com/50' },
